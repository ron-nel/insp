			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-8 col-lg-7">
					<div class="journal-write">
						<form action="/editJournal/{{$id_journal}}" method="post" class="">
							@csrf
							{{method_field("PATCH")}}
							<textarea name="message" id="message" cols="78" rows="15" class="message rounded" placeholder="How are you feeling lately? Mind sharing your thoughts?">{{$message}}</textarea>
